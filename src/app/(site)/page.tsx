                    ...
                    <section className='grid items-center gap-6 pb-8 pt-6 md:py-10 z-auto'>
                        <div className='flex-center w-full flex-col'>
                            ...
                            <p className='desc text-center'>
                                Go, Grow, Simplify digital and Make your
                                business shine online with our expert
                                digitalization app!
                            </p>
                        </div>
                    </section>
                    <div className='absolute bottom-4 md:bottom-[80px] flex justify-center gap-4 w-full'>
                        <Link
                            href={'/getstart'}
